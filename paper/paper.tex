...
idempotently, registers two project adapters through \texttt{alpasim.models}, converts
AlpaSim prediction inputs into policy-facing route and scene signal, and provides setup,
readiness, launch, and contract-check commands. The contribution is not a new driving
policy, log converter, or public benchmark result. WOD2Sim implements and tests an
adapter contract for turning WOD-style logged-policy interfaces into auditable
closed-loop AlpaSim drivers.
\end{abstract}
