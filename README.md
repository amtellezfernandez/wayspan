...
merge/promote/post repair steps without promoting those rows to a benchmark
claim. Cache rebuilds and live rollouts remain limited to operators with gated
assets and an x86_64 NVIDIA/Docker AlpaSim host.
