...
def main() -> int:
    parser = argparse.ArgumentParser(description="Expand and record the SII 2027 experiment matrix.")
            ...
            if row_blocker is not None:
                ...
                next_rows.append(
                    _blocked_row(
                        row,
                        {
                            ...
                            "detail": (
                                "Matrix was expanded and recorded; pass --execute for real rollout launch."
                            ),
                        },
                    )
                )
                ...
                next_rows.append(
                    _blocked_row(
                        ...
                        {
                            "layer": "deployment",
                            "code": "sii2027_closed_loop_launch_not_implemented",
                            "detail": (
    ...
    _write_csv(
        ...
        ["matrix", "expected_runs", "rows", "attempted", "completed", "failed", "blocked", "claim_valid"],
    )
