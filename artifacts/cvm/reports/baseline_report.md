...
| `make cvm-check PYTHON=./.venv/bin/python` | 0 | Ruff passed; conformance suite passed with 237 passed, 14 skipped, and 15 subtests passed; paper validation passed. |
...
| `./.venv/bin/python scripts/validate_cvm_submission.py` | 0 | Submission validation passed, including per-manifest `failure_attribution` consistency. |
