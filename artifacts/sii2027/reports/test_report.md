...
| Command | Exit | Result |
|---|---:|---|
| `make conformance PYTHON=./.venv/bin/python` | 0 | 219 passed, 14 skipped, 15 subtests passed |
| `make demo PYTHON=./.venv/bin/python` | 0 | synthetic demo generated; benchmark claim false |
| `make sii2027-check PYTHON=./.venv/bin/python` | 0 | lint, conformance, and SII validation passed: 219 passed, 14 skipped, 15 subtests passed |
| `./.venv/bin/python -m pytest -q tests` | 0 | 219 passed, 14 skipped, 15 subtests passed |
...
isolation tests, and evidence hash-mismatch tests.
