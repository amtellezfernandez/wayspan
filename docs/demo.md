...
Default output is `demo/alpabridge-contract-demo`. The directory contains:
...
| `support-bundle.tar.gz` | Portable support bundle built by `alpabridge-support-bundle`. |
