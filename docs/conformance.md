...
The core conformance tier is the dependency-light contract check for AlpaBridge.
...
`make conformance` sets `ALPABRIDGE_CORE_CONFORMANCE=1` and runs the public test
